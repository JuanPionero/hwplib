...
import com.agadasom.hwplib.object.bodytext.control.form.properties.PropertyNormal;
import com.agadasom.hwplib.object.bodytext.control.form.properties.PropertySet;
import com.agadasom.hwplib.object.bodytext.control.gso.*;
...
public class ForControl {
    public static void findInControlList(ArrayList<Control> controlList, FieldFormFinder.Result result,
            FieldFormFinder.Option option) throws FieldFormFinder.StopFindException {
    ...
    private static void findInControl(Control control, FieldFormFinder.Result result, FieldFormFinder.Option option)
            throws FieldFormFinder.StopFindException {
    ...
    private static FieldData fieldDataForAllParagraphs(String fieldName, FieldType fieldType, Object parent,
    ...
    private static void findInTextBox(GsoControl control, TextBox textBox, FieldFormFinder.Result result,
            FieldFormFinder.Option option) throws FieldFormFinder.StopFindException {
        if (textBox == null) {
            return;
        }
