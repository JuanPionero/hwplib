package com.agadasom.hwplib.tool.objectfinder;
...
public class FieldFinder {
     ...
     * @throws UnsupportedEncodingException
     */
    public static String getFieldText(HWPFile hwpFile, ControlType fieldType, String fieldName,
     ...
     * @throws UnsupportedEncodingException
     */
    public static ArrayList<String> getAllFieldText(HWPFile hwpFile, ControlType fieldType, String fieldName,
            TextExtractMethod temInField) throws UnsupportedEncodingException {
        ArrayList<String> textList = new ArrayList<String>();
        for (Section s : hwpFile.getBodyText().getSectionList()) {
