...
public class BorderFillAdder {
    ...
    public boolean equalById(int sourceId, int targetId) {
        ...
        BorderFill source = getBorderFill(docInfoAdder.getSourceHWPFile().getDocInfo().getBorderFillList(),
                sourceId - 1);
        BorderFill target = getBorderFill(docInfoAdder.getTargetHWPFile().getDocInfo().getBorderFillList(),
                targetId - 1);
