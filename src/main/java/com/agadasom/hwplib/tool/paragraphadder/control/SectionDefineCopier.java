...
import com.agadasom.hwplib.object.bodytext.control.sectiondefine.*;
...
public class SectionDefineCopier {
    ...
    private static void header(CtrlHeaderSectionDefine source, CtrlHeaderSectionDefine target,
        ...
        target.setNumberParaShapeId((docInfoAdder == null) ? source.getNumberParaShapeId()
                : docInfoAdder.forParaShape().processById(source.getNumberParaShapeId()));
