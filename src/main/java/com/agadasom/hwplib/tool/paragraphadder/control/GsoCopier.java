...
import com.agadasom.hwplib.object.bodytext.control.gso.shapecomponenteach.*;
import com.agadasom.hwplib.object.bodytext.control.gso.shapecomponenteach.picture.InnerMargin;
import com.agadasom.hwplib.object.bodytext.control.gso.shapecomponenteach.picture.PictureEffect;
import com.agadasom.hwplib.object.bodytext.control.gso.shapecomponenteach.polygon.PositionXY;
import com.agadasom.hwplib.object.bodytext.control.gso.textbox.ListHeaderForTextBox;
...
public class GsoCopier {
    ...
    private static void ole(ControlOLE source, ControlOLE target, DocInfoAdder docInfoAdder) {
        ...
        targetSCO.setBinDataId((docInfoAdder == null) ? sourceSCO.getBinDataId()
                : docInfoAdder.forBinData().processById(sourceSCO.getBinDataId()));
    ...
    private static void objectLinkLine(ControlObjectLinkLine source, ControlObjectLinkLine target,
